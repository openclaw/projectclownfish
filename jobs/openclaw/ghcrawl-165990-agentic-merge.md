...
canonical_hint: "ghcrawl representative #70981 is open; worker must verify it is still the best live canonical."
notes: "Generated from ghcrawl run cluster 165990 on 2026-04-26."
---

# GHCrawl Cluster 165990

Generated from local ghcrawl run cluster 165990 for `openclaw/openclaw`.

Display title:

> fix(gateway): use config-resolved thinking default in session rows
...
- representative: #70981, currently open in local store
- latest member update: 2026-04-26T00:46:52.195Z
...
- #50210 fix(gateway): use default agent model for session defaults
- #54647 Fix ACP session model reporting in sessions list
- #63418 fix(control-ui): show effective thinking default in session settings
...
- #70259 gateway/chat: honor per-agent thinkingDefault in chat.history fallback
...
- #71779 Fix configured thinking default in session rows
