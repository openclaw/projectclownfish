...
canonical_hint: "ghcrawl representative #66176 is open; worker must verify it is still the best live canonical."
notes: "Generated from ghcrawl run cluster 156607 on 2026-04-26."
---

# GHCrawl Cluster 156607

Generated from local ghcrawl run cluster 156607 for `openclaw/openclaw`.

Display title:

> [Bug]: WebChat briefly hides newly sent message before it reappears
...
- representative: #66176, currently open in local store
