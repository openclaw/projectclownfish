...
Last dashboard update: Apr 30, 2026, 02:04 UTC

<!-- projectclownfish-dashboard:start -->
State: Failed clusters need inspection

Scope: 357 active latest cluster reports. 1 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 357 | 100% |
| Policy-archived clusters | 1 | audit |
| Clean completed clusters | 180 | 50.4% |
| Needs-human clusters | 51 | 14.3% |
| Latest successful clusters | 329 | 92.2% |
| Latest failed clusters | 4 | 1.1% |
| Latest cancelled clusters | 0 | 0.0% |
| Run attempts archived | 610 | audit |
| Fix action attempts | 164 | audit |
| Fix actions executed | 0 | 0.0% |
| Fix actions failed | 35 | 21.3% |
| Fix actions blocked | 50 | 30.5% |
| Latest clusters with fix failures | 44 | 12.3% |
| Distinct PRs touched | 1076 | 100% |
| Open PRs tracked | 428 | 39.8% |
| Closed unmerged PRs tracked | 529 | 49.2% |
