...
Last dashboard update: Apr 27, 2026, 22:33 UTC

<!-- projectclownfish-dashboard:start -->
State: Failed clusters need inspection

Scope: 159 active latest cluster reports. 1 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 159 | 100% |
| Policy-archived clusters | 1 | audit |
| Clean completed clusters | 74 | 46.5% |
| Needs-human clusters | 43 | 27.0% |
| Latest successful clusters | 157 | 98.7% |
| Latest failed clusters | 2 | 1.3% |
| Latest cancelled clusters | 0 | 0.0% |
| Run attempts archived | 370 | audit |
| Fix action attempts | 85 | audit |
| Fix actions executed | 0 | 0.0% |
| Fix actions failed | 21 | 24.7% |
| Fix actions blocked | 21 | 24.7% |
| Latest clusters with fix failures | 17 | 10.7% |
| Distinct PRs touched | 650 | 100% |
| Open PRs tracked | 301 | 46.3% |
| Closed unmerged PRs tracked | 286 | 44.0% |
