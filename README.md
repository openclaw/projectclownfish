...
Last dashboard update: Apr 30, 2026, 01:30 UTC

<!-- projectclownfish-dashboard:start -->
State: Failed clusters need inspection

Scope: 340 active latest cluster reports. 1 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 340 | 100% |
| Policy-archived clusters | 1 | audit |
| Clean completed clusters | 163 | 47.9% |
| Needs-human clusters | 51 | 15.0% |
| Latest successful clusters | 312 | 91.8% |
| Latest failed clusters | 4 | 1.2% |
| Latest cancelled clusters | 0 | 0.0% |
| Run attempts archived | 593 | audit |
...
| Distinct PRs touched | 1054 | 100% |
| Open PRs tracked | 409 | 38.8% |
| Closed unmerged PRs tracked | 526 | 49.9% |
