...
Scope: 158 active latest cluster reports. 1 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 158 | 100% |
| Policy-archived clusters | 1 | audit |
| Clean completed clusters | 74 | 46.8% |
| Needs-human clusters | 43 | 27.2% |
| Latest successful clusters | 156 | 98.7% |
| Latest failed clusters | 2 | 1.3% |
| Latest cancelled clusters | 0 | 0.0% |
| Run attempts archived | 369 | audit |
| Fix action attempts | 84 | audit |
| Fix actions executed | 0 | 0.0% |
| Fix actions failed | 21 | 25.0% |
| Fix actions blocked | 20 | 23.8% |
| Latest clusters with fix failures | 16 | 10.1% |
| Distinct PRs touched | 646 | 100% |
| Open PRs tracked | 300 | 46.4% |
| Closed unmerged PRs tracked | 283 | 43.8% |
