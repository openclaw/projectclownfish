...
Last dashboard update: Apr 29, 2026, 05:29 UTC

<!-- projectclownfish-dashboard:start -->
State: Failed clusters need inspection

Scope: 236 active latest cluster reports. 1 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 236 | 100% |
| Policy-archived clusters | 1 | audit |
| Clean completed clusters | 99 | 41.9% |
| Needs-human clusters | 40 | 16.9% |
| Latest successful clusters | 224 | 94.9% |
| Latest failed clusters | 3 | 1.3% |
| Latest cancelled clusters | 0 | 0.0% |
| Run attempts archived | 474 | audit |
| Fix action attempts | 160 | audit |
| Fix actions executed | 0 | 0.0% |
| Fix actions failed | 35 | 21.9% |
| Fix actions blocked | 48 | 30.0% |
| Latest clusters with fix failures | 43 | 18.2% |
| Distinct PRs touched | 822 | 100% |
| Open PRs tracked | 297 | 36.1% |
| Closed unmerged PRs tracked | 429 | 52.2% |
...
| Blocked mutation attempts | 104 | 37.7% |
| Skipped mutation attempts | 119 | 43.1% |
...
| job does not allow merge | 3 | [clawsweeper-commit-openclaw-openclaw-5435591f6a1a](results/openclaw/clawsweeper-commit-openclaw-openclaw-5435591f6a1a.md) |
