...
Last dashboard update: Apr 27, 2026, 04:58 UTC

<!-- projectclownfish-dashboard:start -->
State: Fix execution needs repair

Scope: 107 active latest cluster reports. 1 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 107 | 100% |
| Policy-archived clusters | 1 | audit |
| Clean completed clusters | 57 | 53.3% |
| Needs-human clusters | 31 | 29.0% |
| Latest successful clusters | 107 | 100.0% |
| Latest failed clusters | 0 | 0.0% |
| Latest cancelled clusters | 0 | 0.0% |
| Run attempts archived | 229 | audit |
| Fix action attempts | 9 | audit |
| Fix actions executed | 0 | 0.0% |
| Fix actions failed | 3 | 33.3% |
| Fix actions blocked | 4 | 44.4% |
| Latest clusters with fix failures | 4 | 3.7% |
| Distinct PRs touched | 492 | 100% |
| Open PRs tracked | 289 | 58.7% |
| Closed unmerged PRs tracked | 171 | 34.8% |
| Completed close actions | 22 | 11.9% |
| Completed merge actions | 4 | 2.2% |
| Duplicate closes | 22 | 100.0% |
| Superseded closes | 0 | 0.0% |
| Fixed-by-candidate closes | 0 | 0.0% |
| Low-signal PR closes | 0 | 0.0% |
| Blocked mutation attempts | 41 | 22.2% |
| Skipped mutation attempts | 118 | 63.8% |
