...
Scope: 180 active latest cluster reports. 1 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 180 | 100% |
| Policy-archived clusters | 1 | audit |
| Clean completed clusters | 85 | 47.2% |
| Needs-human clusters | 42 | 23.3% |
| Latest successful clusters | 178 | 98.9% |
| Latest failed clusters | 2 | 1.1% |
| Latest cancelled clusters | 0 | 0.0% |
| Run attempts archived | 405 | audit |
...
| Distinct PRs touched | 718 | 100% |
| Open PRs tracked | 314 | 43.7% |
| Closed unmerged PRs tracked | 325 | 45.3% |
