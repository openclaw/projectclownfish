...
Last dashboard update: Apr 30, 2026, 01:31 UTC

<!-- projectclownfish-dashboard:start -->
State: Failed clusters need inspection

Scope: 341 active latest cluster reports. 1 policy-archived cluster(s) are excluded from health stats; run attempts are tracked as audit history only.

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 341 | 100% |
| Policy-archived clusters | 1 | audit |
| Clean completed clusters | 164 | 48.1% |
| Needs-human clusters | 51 | 15.0% |
| Latest successful clusters | 313 | 91.8% |
| Latest failed clusters | 4 | 1.2% |
| Latest cancelled clusters | 0 | 0.0% |
| Run attempts archived | 594 | audit |
...
| Distinct PRs touched | 1056 | 100% |
| Open PRs tracked | 411 | 38.9% |
